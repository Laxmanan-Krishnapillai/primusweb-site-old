      ...
      >
        ...
        <section className="mb-40 w-full flex flex-col lg:flex-row items-start px-4">
          ...
          <div className="w-full flex flex-col mt-10 lg:w-1/2 lg:order-1 lg:m-auto lg:p-4">
            <h2 className="text-4xl lg:text-6xl font-black uppercase bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500 mb-5">
              Hvem er vi?
            </h2>
            ...
            <Link href="/om-os">
              <div className="cursor-pointer rounded-md px-4 py-2 lg:px-10 lg:text-2xl lg:py-4 uppercase bg-gradient-to-r from-pink-500 to-violet-500 font-black text-white w-auto text-center max-w-[10rem] lg:max-w-[15rem]">
                Læs mere
              </div>
            </Link>
          </div>
        ...
        <section className="gap-x-8 px-8 w-screen flex flex-col lg:px-4 mt-1/2 text-center lg:grid grid-cols-2 grid-rows-2 mb-40">
          <h2 className="col-span-2 text-4xl lg:text-6xl font-black lg:self-end uppercase bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500 mb-10 ">
            Vores services
          </h2>
          <div className="lg:h-4/5 lg:w-4/5 lg:mx-auto self-center lg:after:left-0 row-start-2 mt-4 lg:mt-0 w-full flex flex-col items-center justify-center bg-gradient-to-r from-pink-500 to-violet-500 text-white rounded-xl px-4 py-8">
            <h4 className="text-2xl lg:text-4xl font-black ">
              Online visitkort
            </h4>
            <h5 className="relative text-xl lg:text-2xl font-semibold after:absolute after:w-16 after:h-2 after:mt-1 after:left-[calc(50%-2rem)] after:rounded-xl after:block after:bg-white">
          ...
          <div className="lg:h-4/5 lg:w-4/5 self-center row-start-2 mt-8 lg:mt-0 w-full flex flex-col items-center justify-center bg-gradient-to-r from-pink-500 to-violet-500 text-white rounded-xl px-4 py-8">
            <h4 className="text-2xl lg:text-4xl font-black">Ecommerce site</h4>
            <h5 className="relative text-xl lg:text-2xl font-semibold after:absolute after:w-16 after:h-2 after:mt-1 after:left-[calc(50%-2rem)] after:rounded-xl after:block after:bg-white">
        ...
        <section>
          <h2 className="col-span-2 text-4xl text-center mb-4 lg:text-6xl font-black self-center uppercase bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500">
            Kontakt os
          </h2>
          <Form />
        </section>
