...
export function Form({ classNames }) {
    return(
        <form target="_blank" id="kontakt" action="https://getform.io/f/47cde4c7-e57a-403e-971b-aaa0e5134a25" method="POST" className={`grid grid-rows-4 grid-cols-2 px-10 gap-4 max-w-md m-auto border-pink-500 ${classNames}`}>
